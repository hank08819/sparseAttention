"""
model.py — MSCA-SBiGRU: Multi-Scale Cross-Asset Sparse Bidirectional GRU.
...
class MSCABiGRU(nn.Module):
    """Multi-Scale Cross-Asset Sparse Bidirectional GRU (MSCA-SBiGRU).
