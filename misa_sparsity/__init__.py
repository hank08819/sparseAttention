"""
misa_sparsity — Multi-scale Inter-signal Sparse Attention (MISA)
===========================================================================================

Quick start::

    from misa_sparsity import MISABiGRU, sparsemax, build_features, Trainer

    model = MISABiGRU(feat_dim=7, hidden=64, n_heads=4, dropout=0.25)
